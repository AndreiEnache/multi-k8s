docker build -t aenache/multi-client:latest aenache/multi-client:$SHA -f ./client/Dockerfile ./client
docker build -t aenache/multi-server:latest aenache/multi-client:$SHA -f ./server/Dockerfile ./server
docker build -t aenache/multi-worker:latest aenache/multi-client:$SHA -f ./worker/Dockerfile ./worker
